...
#### 1.1 Model Architecture [Dilated Convolution + Depthwise Separable Convolution + Skip Connection + Batch Normalization] Summary gave Parameter Count = 190,509 (Refer the S9.ipnb file for the model summary details)
